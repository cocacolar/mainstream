...
var sliderSource =boxShadowstyle+'<ion-view isHome="true" class="slider-view">'+
...
var mydatas = [
[	"LION HEART",
			  	"JOY FACTORY / 최소영 / ALEXANDER SEAN MICHAEL / SMITH DARREN ELLIS /",
			   	"소녀시대"
			],
			[	"바람이나좀쐐 (Feat. MIWOO)",
			  	"개리 / GroovyRoom",
			...
			[	"취향저격",
			  	"B.I / BOBBY / KUSH / CHOICE37",
			  	"",
			    	"IKON"
			],
			[	"SUGAR",
			  	"POSNER MICHAEL / WALTER HENRY / LEVINE ADAM / COLEMAN JOSHUA / HINDLIN",
			    	"MAROON 5"
			],
			[	"너나잘해",
			  	"이단옆차기 / LONG CANDY / EASTWEST",
			    	"에일리"
			],
			[	"위잉위잉",
			  	"오혁",
...
var mydatatoData = function(mydata,idx){
	mydataresult += '<a class="item item-icon-right" ui-sref="app.notebookpost({id:'+idx+'})"  style="width:100%;margin:0px;">'+
...
'<ion-view class="layouts-view">'+
'  <ion-nav-title>'+
'    <span style="font-weight:bold;">작품 목록</span>'+
'  </ion-nav-title>'+
'  <ion-content>'+
...
'  </button>'+
'</div>'+
'  <div style="margin-top:15px;width:100%;height:25px;clear:both;background-color:#404B5D;font-size:8.5pt;color:white;text-align:center;line-height:25px;"> 총 32,123 건이 검색되었습니다. </div>'+
'    <div class="list layouts-functionalities">'+
mydataresult+
'    </div>'+
pagefootermargin+
