...
.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider) {
  ...
  .state('app', {
    ...
    .state('app.intropage', {
      url: '/intropage',
          templateUrl: "views/app/intropage.html",
          controller: 'introPageCtrl'
    })
  ...
  .state('app.notebookpost', {
    url: "/notebookpost:id",
    views: {
      'menuContent': {
        templateUrl: "views/app/notebookpost.html",
  ...
  .state('app.resultSearch', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/resultSearch.html",
      }
    }
  })
  ...
  .state('app.notebook', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/notebook.html",
      }
    }
  })


  .state('app.calcdetail', {
    url: "/calcdetail:id",
    views: {
      'menuContent': {
        templateUrl: "views/app/calcdetail.html",
		controller: "calcCtrl"
      }
    }
  })

  .state('app.calcNewAuthor', {
    url: "/calcNewAuthor",
    views: {
      'menuContent': {
        templateUrl: "views/app/calcna.html"
      }
    }
  })

  .state('app.calcNewAuthorDetail', {
    url: "/calcNewAuthorDetail",
    views: {
      'menuContent': {
        templateUrl: "views/app/calcnada.html"
      }
    }
  })
  ...
  .state('app.calcLocal', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/calcl.html"
      }
    }
  })

  .state('app.calcLocalDetail', {
    url: "/calcLocalDetail",
    views: {
      'menuContent': {
        templateUrl: "views/app/calcld.html"
      }
    }
  })

  .state('app.calcDateDetailSource', {
    url: "/calcDateDetailSource",
    views: {
      'menuContent': {
        templateUrl: "views/app/calcdd.html",
		controller: "calcMainstreamCtrl"
      }
    }
  })

  .state('app.calcauthor', {
    url: "/calcauthor",
    views: {
      'menuContent': {
        templateUrl: "views/app/calcauthor.html",
		controller: "calcCtrl"
      }
    }
  })
  ...
  .state('app.calcmainstream', {
    url: "/mainStreamDetail",
    views: {
      'menuContent': {
        templateUrl: "views/app/mainStreamDetail.html",
		controller: "calcMainstreamCtrl"
      }
    }
  })
    ...
    .state('app.calc', {
      ...
      views: {
        'menuContent': {
          templateUrl: "views/app/calc.html",
        }
      }
    })
          ...
          .state('app.managerment', {
            url: "/managerment",
            views: {
              'menuContent': {
                templateUrl: "views/app/managerment.html",
              }
            }
          })


        .state('app.managerment2', {
          url: "/managerment2",
          views: {
            'menuContent': {
              templateUrl: "views/app/managerment2.html",
            }
          }
        })
        ...
        .state('app.useallow', {
          ...
          views: {
            'menuContent': {
              templateUrl: "views/app/useallow.html",
            }
          }
        })
        ...
        .state('app.useallow2', {
          ...
          views: {
            'menuContent': {
              templateUrl: "views/app/useallow2.html",
            }
          }
        })

  .state('app.notebookpost2', {
    url: "/notebookpost2",
    views: {
      'menuContent': {
        templateUrl: "views/app/notebookpost2.html",
      }
    }
  })
